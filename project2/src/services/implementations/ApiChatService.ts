...
export class ApiChatService implements ChatService {
  ...
  async getConversation(_id: string): Promise<Conversation> {
    ...
    return await this.makeRequest<Conversation>(`/conversations/${_id}`,
          {
            method: "GET"
          }
        )
  ...
  async getExpertQueue(): Promise<ExpertQueue> {
    ...
    //
    // See API_SPECIFICATION.md for endpoint details
    return await this.makeRequest<ExpertQueue>(`/expert/queue`,
              {
                method: "GET",
              }
            )
  ...
  async claimConversation(conversationId: string): Promise<void> {
    ...
    //
    // See API_SPECIFICATION.md for endpoint details
    return await this.makeRequest<void>(`/expert/conversations/${conversationId}/claim`,
                  {
                    method: "POST",
                  }
                )
  ...
  async unclaimConversation(conversationId: string): Promise<void> {
    ...
    return await this.makeRequest<void>(`/expert/conversations/${conversationId}/unclaim`,
                  {
                    method: "POST",
                  }
                )
  ...
  async getExpertAssignmentHistory(): Promise<ExpertAssignment[]> {
    ...
    //
    // See API_SPECIFICATION.md for endpoint details
    return await this.makeRequest<ExpertAssignment[]>("/expert/assignments/history",
          {
            method: "GET",
          }
        )
